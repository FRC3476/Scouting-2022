            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <script type="text/javascript">
                        ...
                        function drawPoint() {
                            ...
                            var b = matchToPoints1[matchNumber];
                            for (var i = 0; i != a.length; i++) {
                                if (((b[i][1] / (b[i][2] + b[i][1])) >= 0.9)) {
                                    context.fillStyle = "#3cff00";
                                    context.fillRect((5 / 6) * (a[i][0]), (5 / 6) * (a[i][1]), 3, 3);
                                    console.log(b[i][1]);
                ...
                <div class="col-md-6">
                    ...
                    <script type="text/javascript">
                        ...
                        for ($i = 0; $i != sizeof($teamData2[8]); $i++) {
                            echo ("matchToPoints3[" . $teamData2[8][$i][2] . "] = " . $teamData2[8][$i][24] . ";");
                        }
                        for ($i = 0; $i != sizeof($teamData2[8]); $i++) {
                        ...
                        function drawPoint2() {
                            ...
                            for (var i = 0; i != a.length; i++) {
                                if (((b[i][1] / (b[i][2] + b[i][1])) >= 0.9)) {
                                    ...
                                    context2.fillRect((5 / 6) * (a[i][0]), (5 / 6) * (a[i][1]), 3, 3);
                                    console.log(b[i][1]);
                                } else if (((b[i][1] / (b[i][2] + b[i][1])) >= 0.5)) {
