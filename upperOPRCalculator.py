...
def main(key):
	...
	for i in range (0, length):
		...
		if (data[i]["score_breakdown"] != None):
			print (data[i]["alliances"]["red"]["team_keys"][0],", ", data[i]["alliances"]["red"]["team_keys"][1],", ", data[i]["alliances"]["red"]["team_keys"][2],", ", (data[i]["score_breakdown"]["red"]["autoCellsUpper"])+(data[i]["score_breakdown"]["red"]["teleopCellsUpper"]),", ", data[i]["alliances"]["blue"]["team_keys"][0],", ", data[i]["alliances"]["blue"]["team_keys"][1],", ", data[i]["alliances"]["blue"]["team_keys"][2],", ", (data[i]["score_breakdown"]["blue"]["autoCellsUpper"])+(data[i]["score_breakdown"]["blue"]["teleopCellsUpper"]),file = f1)
	f1.flush()
