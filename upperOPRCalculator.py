...
def main(key):
	...
	for i in range (0, length):
		...
		if (data[i]["score_breakdown"] != None):
			print (data[i]["alliances"]["red"]["team_keys"][0],", ", data[i]["alliances"]["red"]["team_keys"][1],", ", data[i]["alliances"]["red"]["team_keys"][2],", ", (data[i]["score_breakdown"]["red"]["autoCargoUpperBlue"])+(data[i]["score_breakdown"]["red"]["autoCargoUpperFar"])+(data[i]["score_breakdown"]["red"]["autoCargoUpperNear"])+(data[i]["score_breakdown"]["red"]["autoCargoUpperRed"])+(data[i]["score_breakdown"]["red"]["teleopCargoUpperBlue"])+(data[i]["score_breakdown"]["red"]["teleopCargoUpperFar"])+(data[i]["score_breakdown"]["red"]["teleopCargoUpperNear"])+(data[i]["score_breakdown"]["red"]["teleopCargoUpperRed"]),", ", data[i]["alliances"]["blue"]["team_keys"][0],", ", data[i]["alliances"]["blue"]["team_keys"][1],", ", data[i]["alliances"]["blue"]["team_keys"][2],", ", (data[i]["score_breakdown"]["blue"]["autoCargoUpperBlue"])+(data[i]["score_breakdown"]["blue"]["autoCargoUpperFar"])+(data[i]["score_breakdown"]["blue"]["autoCargoUpperNear"])+(data[i]["score_breakdown"]["blue"]["autoCargoUpperRed"])+(data[i]["score_breakdown"]["blue"]["teleopCargoUpperBlue"])+(data[i]["score_breakdown"]["blue"]["teleopCargoUpperFar"])+(data[i]["score_breakdown"]["blue"]["teleopCargoUpperNear"])+(data[i]["score_breakdown"]["blue"]["teleopCargoUpperRed"]),file = f1)
	f1.flush()
